...
#define FeaturedString          @"&@=@&"//xiaodong
...
- (void)setQueryString:(NSString *)query
{
	...
	for (NSString* item in components)
	{
        ...
        NSString *itemCopy = [item copy];
        NSRange range = [itemCopy rangeOfString:EqualString];
        if (range.location != NSNotFound) {
             itemCopy = [itemCopy stringByReplacingCharactersInRange:range withString:FeaturedString];
             keyValue = [itemCopy componentsSeparatedByString:FeaturedString];
        } else {
            keyValue = [itemCopy componentsSeparatedByString:EqualString];
        }
